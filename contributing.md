...
GitHub tracked Bugs as Issues.Firstly follow the [ GitHub Issues ](https://github.com/99xt/xfinder/issues) to get a overrall idea on GitHub Issues.After you understood what is going on,then create a new Issue on the particular repository and provide necessary Information.
...
* Follow [GitHub CODE_OF_CONDUCT]( https://github.com/99xt/xfinder/blob/master/CODE_OF_CONDUCT.md )  before contributing.
...
GitHub tracked Improvements as Issues.Firstly follow the [ GitHub Issues ](https://developer.github.com/v3/issues/) to get a overrall idea on GitHub Issues.After you understood what is going on,then create a new Issue on the particular repository and provide necessary Information.
